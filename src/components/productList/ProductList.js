...
const products = [
  ...
  },
  {
    ...
    detail:
      "Excelente traccion, excelente comodidad, excelente diseño, creadas por y para jugadores de alto nivel deportivo que esperan unas zapatillas a la altura de su juego",
  },
  {
    category: "paul",
    id: 13,
  ...
  },
  {
    ...
    detail:
      'Diseñada para los más rápidos de la pista, con piezas de refuerzo y materiales de gran calidad , zapatilla de alta gama. La Kyrie Low 3 "Eclipse" simboliza el equilibrio entre los opuestos, con patrones intrincados en la puntera y la correa y un emblema amarillo en el talón.',
  },
  {
    category: "jordan",
    id: 16,
  ...
  },
  {
    ...
    detail:
      " Muévete rápido en tus límites con el Kyrie Flytrap 4, un calzado que es ligero y brinda soporte y libertad de movimiento. Cuenta con un agarre actualizado, un ajuste firme y una amortiguación eficaz. El unidad Air Zoom de gran tamaño devuelve más energía que el modelo anterior.",
  },
];
